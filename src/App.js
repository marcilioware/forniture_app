...
class App extends Component {
  ...
  _renderRoomOptions = room => {
    ...
    arr.push(
      <View>
        <Text>Algum item que não está listado? Informe abaixo:</Text>
        <View>
          <TextInput
  ...
  render() {
    return (
      <View style={{ height: 500 }}>
              ...
              <ScrollView>
                <View style={{ flex: 1, flexDirection: "row" }}>
                  ...
                  <View style={{ flex: 1, flexDirection: "row", height: 40 }}>
                    ...
                    />
                    <Button title="photo" onPress={() => this.addItemPhoto()} />
                  </View>
                </View>
              </ScrollView>
            );
        ...
        <View flex="1" style={{ position: "absolute", right: 0, bottom: 0 }}>
          {this._nextRoomButton()}
        </View>
      </View>
    );
  }
