    ...
    return (
      <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
        ...
        >
          ...
          >
            Algum item não está listado?
          </Text>

          <TouchableWithoutFeedback>
            <View style={styles.buttonCustom_Outline}>
              <Text style={styles.buttonCustomText_Outline}>
